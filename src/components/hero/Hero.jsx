...
const ImageList = [
  {
    ...
    description:
      "bradie poa slides about electronics.",
  },
  {
    id: 2,
    img: Image2,
    ...
    description:
      "Who's there lorem ipsum dolor sit  magna aliqua.",
  },
  {
    id: 3,
    img: Image3,
    ...
    description:
      "Bradie poa el side 3 ore magna aliqua.",
  },
];
...
const Hero = ({ handleOrderPopup }) => {
  ...
  return (
    <div className="relative overflow-hidden min-h-[550px] sm:min-h-[650px]
     bg-gray-200 flex justify-center items-center dark:bg-gray-950 dark:text-white duration-200 ">
      {/* background pattern */}
